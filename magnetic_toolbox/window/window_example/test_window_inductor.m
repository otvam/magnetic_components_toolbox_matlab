function test_window_inductor()
% Compute the leakage inductance, winding losses, and size of an inductor (core and winding head)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%% winding
winding.conductor = get_conductor_litz(100e-6, 2500, 0.5);
winding.external = struct('type', 'left', 'd_shift', 3e-3, 'h_shift', 0.0);
winding.internal = struct('n_winding', [6 6], 'n_par', 2, 't_layer', 1e-3, 't_turn', 0.5e-3, 'orientation', 'vertical');
...
for i=1:length(window_geom_class)
    class.window_component_class = @window_component_inductor;
