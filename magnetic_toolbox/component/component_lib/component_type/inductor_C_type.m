% =================================================================================================
% Definition of a standard inductor with a C-core.
% =================================================================================================
%
% Inductor with one winding.
% Inductor with a C-core.
%
% =================================================================================================
%
% See also:
...
% =================================================================================================
classdef inductor_C_type < component_type_abstract
    %% init
    methods (Access = public)
        function self = inductor_C_type(core, winding)
            % create the object
            ...
            % get the core window
            data_add = struct('type', 'inductor', 'geom', 'core', 'z_mean', self.core.z_core, 'z_left', self.core.z_core, 'z_right', self.core.z_core, 'd_core', 0.0);
            ...
            data_add = struct('type', 'inductor', 'geom', 'core_head', 'z_mean', z_core, 'z_left', z_core, 'z_right', z_core, 'd_core', 0.0);
            ...
            % get the core
            data_add = struct('type', 'inductor', 'geom', 'C_type', 'd_window', self.window.d, 'h_window', self.window.h);
