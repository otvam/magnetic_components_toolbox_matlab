...
sweep = {};
sweep{end+1} = struct('f_sw', logspace(log10(50e3), log10(250e3), 5)); % switching frequency
sweep{end+1} = struct('r_gap', logspace(log10(0.005), log10(0.2), 5)); % relative air gap length
sweep{end+1} = struct('A_core', logspace(log10(25e-6), log10(1000e-6), 5)); % core cross section
sweep{end+1} = struct('r_core', logspace(log10(1.0), log10(3.0), 5)); % core aspect ratio
sweep{end+1} = struct('A_litz', logspace(log10(5e-6), log10(20e-6), 5)); % wire copper area
